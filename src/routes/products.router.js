...
router.post("/", async (req, res) => {
  try {
    const newProduct = await productManager.addProduct(req.body); // Agrega el producto recibido en el body
    res.status(201).json({ product: newProduct }); // Responde con el producto creado
  } catch (error) {
